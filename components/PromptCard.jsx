...
const PromptCard = ({post,handleTagClick,handleEdit,handleDelete}) => {
  ...
  return (
    <div className='flex-1 font-roboto rounded-lg border border-gray-200 bg-white/20 bg-clip-padding p-6 backdrop-blur-lg pb-4 backdrop-filter md:w-[360px] w-full h-fit'>
       ...
       <p className='text-sm gradient bg-clip-text cursor-pointer' onClick={()=>handleTagClick && handleTagClick(post.tag)}>#{post.tag}</p>
       {
